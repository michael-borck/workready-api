# Historical WorkReady system map

> Archived on 14 September 2026 during documentation consolidation. This mixed-era snapshot contains superseded login, storage, deployment and roadmap claims. Its private memory-file references are not required project documentation. Use the [current project guides](https://github.com/michael-borck/workready-deploy/blob/main/docs/README.md) and [API README](../../README.md). Do not execute the old deployment or data-reset instructions as a current procedure.
